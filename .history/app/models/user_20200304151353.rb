class User < ApplicationRecord
  ...
  scope   :service_center_admins, ->{User.joins(:roles).where("roles.name = ?", 'service_center_admin')}
  scope   :company_admins, ->{User.joins(:roles).where("roles.name = ?", 'service_center_admin')}
